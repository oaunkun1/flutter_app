...
//
//     final coivdResult = coivdResultFromJson(jsonString);

import 'dart:convert';

CoivdResult coivdResultFromJson(String str) =>
    CoivdResult.fromJson(json.decode(str));

String coivdResultToJson(CoivdResult data) => json.encode(data.toJson());
...
class CoivdResult {
  ...
  factory CoivdResult.fromJson(Map<String, dynamic> json) => CoivdResult(
